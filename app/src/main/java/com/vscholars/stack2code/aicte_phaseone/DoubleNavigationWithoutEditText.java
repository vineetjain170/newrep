...
public class DoubleNavigationWithoutEditText extends ActionBarActivity{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_sign_out) {
                    ...
                    if (executer.success==1){
                        ...
                        Handler mHandler=new Handler(Looper.getMainLooper()) {
                            ...
                            public void handleMessage(Message message) {
                                AlertDialog.Builder builder = new AlertDialog.Builder(DoubleNavigationWithoutEditText.this);
            ...
            sendIntent.putExtra(Intent.EXTRA_SUBJECT, "Add Subject Here");
            sendIntent.putExtra(Intent.EXTRA_TEXT, "Add your issue here...");
